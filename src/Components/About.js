    ...
    >
      <div className="container py-5">
        ...
        <div className="text-center mb-5">
          ...
          ></div>
          <p className="text-light mx-auto mb-4 fs-5 px-5">
            I am Sunidhi Kumari, a final-year Dual Degree student in Computer
            Science & Engineering with Data Science at NIT Patna. I am
            passionate about software engineering and enjoy transforming ideas
            into responsive, scalable, and user-friendly applications.
          </p>
        </div>
          ...
          <div className="col-lg-8">
            ...
            >
              <div className="row gy-3">
                ...
                <div className="col-md-6">
                  <div className="d-flex flex-wrap align-items-center">
                    <strong className="text-info me-2">
